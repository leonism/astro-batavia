;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0f845382-f894-4b0f-9359-3da74a818e57",e._sentryDebugIdIdentifier="sentry-dbid-0f845382-f894-4b0f-9359-3da74a818e57")}catch(e){}}();import { b as createAstro, c as createComponent, e as addAttribute, d as renderScript, a as renderTemplate, m as maybeRenderHead, r as renderComponent, F as Fragment, k as renderHead, g as renderSlot } from './astro/server.CrcP_Q54.js';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
import { g as getLangFromUrl, u as useTranslations, a as getLocalizedPath, r as removeLocaleFromPath, l as languages } from './utils.BsNdZzoF.js';
...
const $$FooterBottomBar = createComponent(($$result, $$props, $$slots) => {
  ...
  const t = useTranslations(lang);
  return renderTemplate`${maybeRenderHead()}<footer class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700"> <div class="flex flex-col md:flex-row justify-between items-center gap-4"> <div class="flex items-center gap-4"> <p class="text-gray-500 dark:text-gray-400 text-sm">
© ${currentYear} Astro Batavia. ${t("footer.copyright")} </p> <a href="/rss.xml" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 transition-colors duration-200" aria-label="RSS Feed"> <svg class="sm:w-3 sm:h-3 w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path fill-rule="evenodd" d="M19.199 24C19.199 13.467 10.533 4.8 0 4.8V0c13.165 0 24 10.835 24 24h-4.801zM3.291 17.415a3.3 3.3 0 013.293 3.295A3.303 3.303 0 013.283 24C1.47 24 0 22.526 0 20.71s1.475-3.294 3.291-3.295zM15.909 24h-4.665c0-6.169-5.075-11.245-11.244-11.245V8.09c8.727 0 15.909 7.184 15.909 15.91z" clip-rule="evenodd"></path> </svg> </a> </div> <p class="text-gray-500 dark:text-gray-400 text-sm"> ${t("footer.built-with")} <a href="https://astro.build" target="_blank" rel="noopener noreferrer" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors duration-200 ml-1" aria-label="Astro">
Astro
</a> </p> </div> </footer>`;
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const navigationLinks = [
    { href: `/`, text: t("nav.home"), isLocalized: true },
    // Assuming home should be localized
    { href: `/blog`, text: t("nav.blog"), isLocalized: true },
    // Assuming blog should be localized
    { href: `/about`, text: t("nav.about"), isLocalized: true },
    // Assuming about should be localized
    { href: `/services`, text: t("nav.services"), isLocalized: true },
    // Assuming services should be localized
    { href: `/search`, text: t("nav.search"), isLocalized: true }
    // Assuming search should be localized
  ];
  const legalLinks = [
    {
      href: `/cookies`,
...
const $$SEO = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Basic Meta Tags --><title>${fullTitle}</title><meta name="description"${addAttribute(description, "content")}>${noindex && renderTemplate`<meta name="robots" content="noindex, nofollow">`}${canonical && renderTemplate`<link rel="canonical"${addAttribute(canonicalUrl, "href")}>`}<!-- Open Graph --><meta property="og:type"${addAttribute(type, "content")}><meta property="og:title"${addAttribute(fullTitle, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(imageUrl, "content")}><meta property="og:url"${addAttribute(canonicalUrl, "content")}><meta property="og:site_name"${addAttribute(siteTitle, "content")}><meta property="og:locale"${addAttribute(hreflangMap[lang], "content")}>${type === "article" && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${publishedTime && renderTemplate`<meta property="article:published_time"${addAttribute(publishedTime, "content")}>`}${modifiedTime && renderTemplate`<meta property="article:modified_time"${addAttribute(modifiedTime, "content")}>`}${author && renderTemplate`<meta property="article:author"${addAttribute(author, "content")}>`}${tags.map((tag) => renderTemplate`<meta property="article:tag"${addAttribute(tag, "content")}>`)}` })}`}<!-- Twitter Card --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(fullTitle, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image"${addAttribute(imageUrl, "content")}><!-- Hreflang Tags -->${Object.entries(alternateUrls).map(([langCode, url]) => renderTemplate`<link rel="alternate"${addAttribute(hreflangMap[langCode], "hreflang")}${addAttribute(url, "href")}>`)}<link rel="alternate" hreflang="x-default"${addAttribute(alternateUrls.en, "href")}><!-- Additional Meta Tags --><meta name="theme-color" content="#3b82f6"><meta name="msapplication-TileColor" content="#3b82f6"><meta name="apple-mobile-web-app-status-bar-style" content="black" name="apple-mobile-web-app-capable" content="yes"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><!-- Favicon --><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="manifest" href="/site.webmanifest">`;
