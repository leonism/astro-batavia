;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="a394e3df-d9c9-451f-9db5-cd06ce798c72",e._sentryDebugIdIdentifier="sentry-dbid-a394e3df-d9c9-451f-9db5-cd06ce798c72")}catch(e){}}();import { b as createAstro, c as createComponent, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, k as renderSlot, r as renderComponent, F as Fragment, a as renderTemplate, u as unescapeHTML } from './astro/server.Ib_pSZqu.js';
import 'kleur/colors';
import { a as getLangFromUrl, u as useTranslations, g as getLocalizedPath } from './utils.D0MtOyzB.js';
import 'clsx';
import { g as getCollection } from './_astro_content.cbhryw56.js';
...
const $$PostTitle = createComponent(($$result, $$props, $$slots) => {
  ...
  ]], "class:list")}${addAttribute(index === 0 ? 1 : 2, "aria-level")}> <a${addAttribute(`/${post.slug}`, "href")} class="hover:text-primary-200 focus:text-primary-200 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors duration-200 line-clamp-2"${addAttribute(`featured-post-desc-${post.slug}`, "aria-describedby")}> ${post.data.title} </a> </h2>`;
